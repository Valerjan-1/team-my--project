...
//         booksList.innerHTML = `<li id="${book._id}" class="bs-book-item">
//           <img src="${book.book_image}" alt="${book.title}" />
//           <p class="title-book">${book.title}</p>

//           <p class="author-book">${book.author}</p></li>
//         `;
//         // const bookItem = document.querySelector('.bs-book-item');
...
// const elements = document.getElementsByClassName(listCategory);
// console.dir(listCategory.children);
// getTopBooks()
//   .then(data => {
//     const categoryListContainer = document.querySelector('.book-category-list');
